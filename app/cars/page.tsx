      ...
      <section className="search-panel" aria-label="Search and filters">
        ...
        <div className="filter-row">
          ...
          <label htmlFor="transmission-filter">
            <span>Gearbox</span>
            <select id="transmission-filter" value={transmission} onChange={(event) => setTransmission(event.target.value)}>
          ...
          <button type="button" className="reset-button" onClick={resetFilters}>Clear filters</button>
        </div>
      </section>

      <section className="results-head" aria-live="polite">
        <div><strong>{filteredCars.length}</strong> of <strong>{cars.length}</strong> cars available</div>
      </section>
            ...
            <article className="car-card" key={car.id}>
              ...
              <div className="car-card-body">
                ...
                <div className="card-footer">
                  ...
                  <Link href={`/cars/${car.slug}`} className="details-button">View details</Link>
                </div>
              </div>
            </article>
          ))}
