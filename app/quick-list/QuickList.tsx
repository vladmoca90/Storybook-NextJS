...
export default function QuickList() {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.app} aria-labelledby="list-title">
        <header className={styles.header}>
          ...
          <div className={styles.eyebrow}>A little space for big plans</div>
          <h1 id="list-title">What&apos;s on your mind?</h1>
          <p className={styles.intro}>
            Add anything you want to remember. One thought at a time.
          </p>
        </header>
